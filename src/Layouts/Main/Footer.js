...
const Footer = () => {
  return (
    <section className="bg-primary py-14">
      <div className="grid lg:grid-cols-4 gap-8 text-[#fff] w-[80%] mx-auto py-20 border-b border-blue">
        <div>
          <div>
        ...
        <div>
          ...
          <div>
            <p className="text-[14px] mb-5">
              Enter your email and get latest updates and offers from NHP.
            </p>
            <div>
              <input
                type=""
                name=""
                className="py-3 px-4 border border-blue outline-none bg-primary"
